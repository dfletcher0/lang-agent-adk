...
3. `update_leaderboard`: Updates the leaderboard with the student's latest test result
4. `get_leaderboard`: Gets the current top 5 test scores for the student
5. `update_leaderboard`: Allows you to add the latest test result to the leaderboard for future reference
...
5. Give a summary of the feedback generated by the `review_agent` agent tool to the student, rephrasing it to speak directly to the student as if you produced the feedback directly. Always provide the overall test score as an integer.
