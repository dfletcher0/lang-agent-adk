...
from .callbacks import after_review_agent_callback, build_before_review_agent_callback
...
review_agent = LlmAgent(
    ...
    before_agent_callback=build_before_review_agent_callback(db=GRAMMAR_DB),
